...
<script runat="server">
    ...
    public override void SetConfig()
    {
        ...
        //BaseUrl = "/Scripts/ckeditor/ckfinder/userfiles/";
        BaseUrl = ConfigurationManager.AppSettings["CkFinder.BaseUrl"].ToString();

        // The phisical directory in the server where the file will end up. If
        // blank, CKFinder attempts to resolve BaseUrl.
        //BaseDir = "D:/Project/LPGA/WebSite/src/WebSite/Scripts/ckeditor/ckfinder/userfiles/";
        BaseDir = ConfigurationManager.AppSettings["CkFinder.BaseDir"].ToString();
