...
{
    public class PublicationLevel1ListModel : PagerModel
    {
		public string Search { get; set; }

		public string ParentId { get; set; }

		public List<PublicationLevel1Model> Data { get; set; }
    }

    public class PublicationLevel1Model : EditModePage
    {
		[Display(Name = "編號")]
